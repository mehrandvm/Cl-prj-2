...
for k = 1 : epoch
    ...
    O1 = tansig(result); 
    O2 = tansig(weight2 * O1 + bias_list2(:,1:100));
    O3 = weight3 * O2 + bias_list3(:,1:100);
       
    % calculating back propagation
    amoozesh_diff3 = amoozesh_data - O3;
    amoozesh_error(k)=sum(amoozesh_diff3*amoozesh_diff3', 2)/(2 * 100); 
